...
FOLDERID = ""
IAMKEY = ""
# Группа хостов по тэгу в YC, переданного терраформом, которую следует исключить, принимает строку
EXCLUDE_GROUP = "stage"
...
for instance in data['instances']:
    # Смотрим переменную группы, если есть убираем её
    if  EXCLUDE_GROUP in instance['name']:
        pass
    else:
