...
## Основная часть
Описаны и подняты 2 виртуалки с помощью vagrant, в которых успешно отрабатывает Ansible.
Переписаны файлы ролей и плейбуков.
Опробована молекула. Дописаны тесты. Всё работает.

ansible-galaxy <2.9.0 больше не скачивает роли, поэтому выпадает весь автотест.
